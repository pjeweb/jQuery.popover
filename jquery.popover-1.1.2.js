			...
			return this.each(function() {
				...
				if ( ! data) {
					...
					if (options.hideOnHTMLClick) {
						...
						$('html').unbind(hideEvent).bind(hideEvent, function() {
		...
		setTrigger: function(trigger) {
			return this.each(function() {
				...
				if (data) {
					...
					if (trigger === 'hover') {
						$anchor.add(popover).bind('mousemove.popover', function() {
							$this.popover('show');
						});
						$anchor.add(popover).bind('mouseleave.popover', function() {
					...
					if (trigger === 'focus') {
						$anchor.add(popover).bind('focus.popover', function() {
							$this.popover('show');
						});
						$anchor.add(popover).bind('blur.popover', function() {
							$this.popover('fadeOut');
						});
